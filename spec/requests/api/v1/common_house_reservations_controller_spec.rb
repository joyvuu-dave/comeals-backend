...
RSpec.describe "Common House Reservations API", type: :request do
  ...
  describe "GET /api/v1/common-house-reservations" do
    ...
    it "filters by date range" do
      old = FactoryBot.create(:common_house_reservation, community: community, resident: resident,
        start_date: 1.year.ago, end_date: 1.year.ago + 1.hour)
      recent = FactoryBot.create(:common_house_reservation, community: community, resident: resident,
        start_date: 1.day.ago, end_date: 1.day.ago + 1.hour)
  ...
  describe "POST /api/v1/common-house-reservations" do
    ...
    it "rejects overlapping reservations in the same community" do
      FactoryBot.create(:common_house_reservation, community: community, resident: resident,
        start_date: Time.zone.local(2026, 5, 1, 14, 0), end_date: Time.zone.local(2026, 5, 1, 17, 0))
  ...
  describe "DELETE /api/v1/common-house-reservations/:id/delete" do
    it "deletes the reservation" do
      ...
      }.to change(CommonHouseReservation, :count).by(-1)
