...
RSpec.describe "Communities API", type: :request do
  ...
  describe "GET /api/v1/communities/:id/hosts" do
    it "returns active adult residents ordered by unit" do
      adult = FactoryBot.create(:resident, community: community, unit: unit, multiplier: 2, active: true)
      child = FactoryBot.create(:resident, community: community, unit: unit, multiplier: 1, active: true)
      inactive = FactoryBot.create(:resident, community: community, unit: unit, multiplier: 2, active: false,
  ...
  describe "GET /api/v1/communities/:id/birthdays" do
    it "returns residents with birthdays in the target month" do
      march_bday = FactoryBot.create(:resident, community: community, unit: unit,
        birthday: Date.new(1990, 3, 15))
      july_bday = FactoryBot.create(:resident, community: community, unit: unit,
  ...
  describe "GET /api/v1/communities/:id/calendar/:date" do
    it "returns calendar data for the month" do
      FactoryBot.create(:meal, community: community, date: Date.new(2026, 4, 10))
