  ...
  render() {
    return(
      <tr>
        ...
        <td><input type="checkbox" checked={this.state.attending} onChange={this.handleAttendClick} /></td>
        <td><input type="checkbox" checked={this.state.late} onChange={this.handleLateClick} disabled={!this.state.attending} /></td>
        <td><input type="checkbox" checked={this.state.vegetarian} onChange={this.handleVegClick} disabled={!this.state.attending} /></td>
        <td>
          <button onClick={this.handleGuestAdd} >Add</button>{this.state.guests}
          <button onClick={this.handleGuestRemove} disabled={this.state.guests === 0}>Remove</button>
        </td>
      </tr>
    )
  }
