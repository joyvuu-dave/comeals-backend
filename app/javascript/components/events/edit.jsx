        ...
        <fieldset className="w-50">
          ...
          <LocalForm
            ...
            initialState={{
              ...
              day: `${new Date(this.props.event.start_date).getFullYear()}-${
                new Date(this.props.event.start_date).getMonth() < 9
                  ? `0${new Date(this.props.event.start_date).getMonth() + 1}`
                  : new Date(this.props.event.start_date).getMonth() + 1
              }-${new Date(this.props.event.start_date).getDate()}`,
              start_time: `${new Date(
                this.props.event.start_date
              ).getUTCHours()}:${
                new Date(this.props.event.start_date).getUTCMinutes() < 10
                  ? `0${new Date(this.props.event.start_date).getUTCMinutes()}`
                  : new Date(this.props.event.start_date).getUTCMinutes()
              }`,
              end_time: `${new Date(this.props.event.end_date).getUTCHours()}:${
                new Date(this.props.event.end_date).getUTCMinutes() < 10
                  ? `0${new Date(this.props.event.end_date).getMinutes()}`
                  : new Date(this.props.event.end_date).getMinutes()
              }`,
